...
public class FavoriteClient {
    ...
    public FavoriteClient() {
        ...
        webTarget = client.target(BASE_URI).path("tupt.entities.favorite");
    }
    ...
    public <T> T createFavorite_XML(Object requestEntity, Class<T> responseType) throws ClientErrorException {
        try {
